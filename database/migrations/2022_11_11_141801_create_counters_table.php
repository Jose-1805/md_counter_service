...
return new class () extends Migration {
    ...
    public function up()
    {
        Schema::create('counters', function (Blueprint $table) {
            ...
            $table->string('item_type', 45)->nullable()->comment('Nombre del modelo o entidad asociado al registro');
            $table->string('item', 45)->nullable()->comment('Identificador del elemento asociado al registro');
